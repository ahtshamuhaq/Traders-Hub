  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white my-3  ">
      ...
      <ul
        className={
          nav
            ? "fixed left-0 mt-[60rem] w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500"
            : "ease-in-out duration-500 fixed left-[-100%]"
        }
      >
        <li className="p-4 border-b hover:cursor-pointer hover:underline hover:text-[#] border-gray-600">
          <Link onClick={handleNav} to="cards">
            Plans
          </Link>
        </li>
        <li className="p-4 border-b hover:cursor-pointer hover:underline hover:text-[#00DDC3] border-gray-600">
        ...
        <li
          onClick={handleNav}
          className="p-4 border-b hover:cursor-pointer hover:underline hover:text-[#00DDC3] border-gray-600"
        >
